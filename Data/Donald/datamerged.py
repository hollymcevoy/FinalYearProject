...
directory = r"C:\Users\holly\OneDrive\Documents\FinalYearProject\Donald\DonaldData"
...
with open(r'C:\Users\holly\OneDrive\Documents\FinalYearProject\Donald\merged_data.txt', 'w', encoding='utf-8') as f:
    for text in texts:
        f.write(text)
