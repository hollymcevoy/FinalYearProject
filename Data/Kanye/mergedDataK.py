...
directory = r"C:\Users\holly\OneDrive\Documents\FinalYearProject\Kanye\KanyeData"
...
with open(r'C:\Users\holly\OneDrive\Documents\FinalYearProject\Kanye\merged_data.txt', 'w', encoding='utf-8') as f:
    for text in texts:
        f.write(text)
